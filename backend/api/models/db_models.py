...
class UserSetting(Base):
    ...
    revchatgpt_ask_limits: Mapped[RevChatGPTAskLimits] = mapped_column(JSON, comment="chatgpt账号对话限制")
    revchatgpt_time_limits: Mapped[RevChatGPTTimeLimits] = mapped_column(JSON, comment="chatgpt账号时间频率限制")
